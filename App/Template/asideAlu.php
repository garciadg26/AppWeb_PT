    ...
    <ul id="menu_aside">
        ...
        <a href="<?php echo constant('URL'); ?>main" class="btn_menu_aside">
            <li class="lista_aside_activo"><i class="icon_menu_aside icon_ms_1"></i>Academia</li>
        </a>
        ...
        <a href="#" class="btn_menu_aside">
            <li class="lista_aside"><i class="icon_menu_aside icon_ms_9"></i>Reportar fallas</li>
        </a>
